...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsGreen(ImGuiStyle* dst = NULL); // classic imgui style
IMGUI_API void          StyleColorsPink(ImGuiStyle* dst = NULL);
    // Windows
    ...
    IMGUI_API ImVec2        CalcTextSize2(const char* text, const char* text_end = NULL, float text_size = 0.0f, bool hide_text_after_double_hash = false, float wrap_width = -1.0f);
