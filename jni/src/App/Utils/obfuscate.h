...
#ifndef AY_inject_DEFAULT_KEY
#define AY_inject_DEFAULT_KEY ay::generate_key(__LINE__)
#endif
...
{
public:
injectd_data(const obfuscator<N, KEY>& obfuscator)
{
...
template <size_type N, key_type KEY = AY_inject_DEFAULT_KEY>
...
#define inject(data) inject_KEY(data, AY_inject_DEFAULT_KEY)
#define inject_KEY(data, key) \
[]() -> ay::injectd_data<sizeof(data)/sizeof(data[0]), key>& { \
...
static auto injectd_data = ay::injectd_data<n, key>(obfuscator); \
return injectd_data; \
}()